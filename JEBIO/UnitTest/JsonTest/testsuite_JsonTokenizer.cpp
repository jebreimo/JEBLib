...
static void testNextToken(JsonTokenizer& tokenizer,
...
static void testNextToken(const std::string& input,
                          JsonTokenizer::TokenType expectedType,
                          const std::string& expectedToken)
{
...
static void testNextToken(const std::string& input1,
...
static void test_NewlineTokens()
{
...
static void test_CommentTokens()
{
    JT_CALL(testNextToken("/", JsonTokenizer::EndOfBuffer, "/"));
    JT_CALL(testNextToken("/", "", JsonTokenizer::Value, "/"));
    JT_CALL(testNextToken("//", JsonTokenizer::EndOfBuffer, "//"));
...
static void test_WhitespaceTokens()
{
...
static void testStructureToken(const std::string token,
                               JsonTokenizer::TokenType expectedType)
{
...
static void test_StructureTokens()
{
